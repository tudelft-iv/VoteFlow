...
class IM2HTFunction(Function):
    ...
    def backward(ctx, grad_vol):
        ...
        grad_input_src, grad_input_dst = im2ht.im2ht_backward(
            grad_vol,
            voxels_src,
            voxels_dst,
            idxs_src,
...
class IM2HT(nn.Module):
    ...
    def forward(self, feats_src, feats_dst, voxels_src, voxels_dst, idxs_src, idxs_dst, h, w, d):  
        ...
        return IM2HTFunction.apply(
            feats_src.contiguous(),
            feats_dst.contiguous(),
